...
ActiveRecord::Schema.define(version: 20140518152314) do
  ...
  create_table "users", force: true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "twitter_access_token",        default: "", null: false
    t.string   "twitter_access_token_secret", default: "", null: false
  end
